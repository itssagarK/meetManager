...
- **Slide-out Side Drawer**: Clean scheduling panel without blocking the screen.
- **Mobile Responsive**: Fully optimized for mobile phones and desktop viewports.
...
- **Database**: SQLite (`better-sqlite3`) with parameterized queries
